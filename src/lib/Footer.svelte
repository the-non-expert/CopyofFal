<div
  class="footer-container container-full mx-auto mt-10 w-full bg-theme px-4 lg:mt-20"
>
  <footer
    class="flex min-h-[424px] w-full flex-col p-4 font-focal text-black md:flex-row"
  >
    <div
      class="mb-6 mr-auto flex w-full max-w-screen-lg flex-col justify-between text-sm"
    >
      <div class="mb-6 mr-auto grid w-full grid-cols-2 md:grid-cols-4">
        <div class="mb-6 flex w-full flex-col space-y-2 md:w-auto">
          <h4 class="mb-5 font-medium">Learn More</h4>
          <a href="https://status.fal.ai">Status</a><a href="/docs"
            >Documentation</a
          ><a href="/pricing">Pricing</a><a href="/grants">Grants</a><a
            href="/about">About Us</a
          ><a
            target="_blank"
            rel="noopener noreferrer"
            href="https://featuresandlabels.notion.site/We-are-hiring-fal-ai-37eece7cf700403fbb63b61b757684c4?pvs=74"
            >Careers</a
          ><a
            target="_blank"
            rel="noopener noreferrer"
            href="https://blog.fal.ai">Blog</a
          ><a href="mailto:support@fal.ai">Get in touch</a>
        </div>
        <div class="mb-6 flex w-full flex-col space-y-2 md:w-auto">
          <span class="mb-5 font-medium">Models</span><a
            href="/models/fal-ai/aura-flow">AuraFlow</a
          ><a href="/models/fal-ai/flux/schnell">Flux.1 [schnell]</a><a
            href="/models/fal-ai/flux/dev">Flux.1 [dev]</a
          ><a href="/models/fal-ai/flux-realism">Flux Realism LoRA</a><a
            href="/models/fal-ai/flux-lora">Flux LoRA</a
          ><a href="/models">Explore More</a>
        </div>
        <div class="mb-6 flex w-full flex-col space-y-2 md:w-auto">
          <h4 class="mb-5 font-medium">Playgrounds</h4>
          <a href="/models/fal-ai/flux-lora-fast-training">Training</a><a
            href="/workflows">Workflows</a
          ><a href="/demos">Demos</a>
        </div>
        <div class="mb-6 flex w-full flex-col space-y-2 md:w-auto">
          <h4 class="mb-5 font-medium">Socials</h4>
          <a href="https://discord.com/invite/Fyc9PwrccF" target="_blank"
            >Discord</a
          ><a href="https://github.com/fal-ai" target="_blank">GitHub</a><a
            href="https://twitter.com/fal_ai_data"
            target="_blank">Twitter</a
          ><a
            href="https://www.linkedin.com/company/features-and-labels/"
            target="_blank">Linkedin</a
          >
        </div>
      </div>
      <div class="my-10 md:mb-0 md:mt-20">
    ...
    <svg
      ...
      class="fill-black ml-auto h-full self-end opacity-30 md:max-h-[110px] lg:max-h-[254px]"
      ><path
